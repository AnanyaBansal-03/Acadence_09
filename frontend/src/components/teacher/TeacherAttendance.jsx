    ...
    try {
      ...
      const records = enrollments?.map(enrollment => {
        ...
        return {
          ...
          isSubmitted: attendanceRecord?.is_submitted || false  // Track submission status
        };
      }) || [];
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200/50">
        ...
        {selectedClass && (
          <div className="bg-gray-50/80 rounded-xl p-6 border border-gray-200/50 mt-6">
            ...
            {attendanceRecords.length > 0 && !attendanceRecords[0]?.isSubmitted && (
              <div className="mb-4 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-semibold text-yellow-800">Attendance Not Yet Submitted</p>
                    <p className="text-sm text-yellow-700">
                      {attendanceRecords.filter(r => r.status === 'present').length} / {attendanceRecords.length} students scanned QR • 
                      Students won't see their attendance until you click "Submit Attendance"
                    </p>
                  </div>
                </div>
              </div>
            ...
            {attendanceRecords.length > 0 && attendanceRecords[0]?.isSubmitted && (
              <div className="mb-4 p-4 bg-green-50 border-l-4 border-green-400 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-semibold text-green-800">Attendance Submitted ✓</p>
                    <p className="text-sm text-green-700">Students can now view their attendance records</p>
                  </div>
                </div>
              </div>
            )}
